...
/**
 * Created by namIT on 8/17/2016.
 */
public class PayNewCardFragment extends Fragment implements View.OnClickListener, View.OnTouchListener, NumberPad.IKeyCode {
    ...
    public static PayNewCardFragment newInstance(int type) {
        PayNewCardFragment fragment = new PayNewCardFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        bank_account = (LinearLayout) view.findViewById(R.id.bank_account);
