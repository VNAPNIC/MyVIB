 ...
 */
public class ESavingsFragment extends Fragment {
    ...
    public static ESavingsFragment newInstance() {
        ESavingsFragment fragment = new ESavingsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        viewRoot = inflater.inflate(R.layout.fragment_e_savings, container, false);
        return viewRoot;
    }
