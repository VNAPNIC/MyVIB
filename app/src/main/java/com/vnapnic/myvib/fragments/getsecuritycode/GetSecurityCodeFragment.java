 ...
 */
public class GetSecurityCodeFragment extends Fragment implements View.OnClickListener, NumberPad.IKeyCode, View.OnTouchListener, ViewDialog.IAction2ButtonV2 {
    ...
    public static GetSecurityCodeFragment newInstance() {
        GetSecurityCodeFragment fragment = new GetSecurityCodeFragment();
        return fragment;
    }

    public static GetSecurityCodeFragment newInstance(SecurityCode securityCode) {
        GetSecurityCodeFragment fragment = new GetSecurityCodeFragment();
