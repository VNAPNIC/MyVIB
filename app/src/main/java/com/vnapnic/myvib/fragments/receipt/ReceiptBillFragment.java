 ...
 */
public class ReceiptBillFragment extends Fragment implements View.OnClickListener {
    private View viewRoot;
    private MainActivity activity;
    private static final String MS = "key.ms";
    private SecurityCode securityCode;

    public static ReceiptBillFragment newInstance(SecurityCode securityCode) {
        ReceiptBillFragment fragment = new ReceiptBillFragment();
