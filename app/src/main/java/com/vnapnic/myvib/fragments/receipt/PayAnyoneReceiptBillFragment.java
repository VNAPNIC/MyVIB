 ...
 */
public class PayAnyoneReceiptBillFragment extends Fragment implements View.OnClickListener {
    private View viewRoot;
    private MainActivity activity;
    private static final String MS = "key.ms";
    private SecurityCode securityCode;

    public static PayAnyoneReceiptBillFragment newInstance(SecurityCode securityCode) {
        PayAnyoneReceiptBillFragment fragment = new PayAnyoneReceiptBillFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tho", "onCreate: Pay anyone fragment");
    }
