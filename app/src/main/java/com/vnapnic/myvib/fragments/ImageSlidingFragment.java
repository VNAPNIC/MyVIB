...
public class ImageSlidingFragment extends Fragment {
    ...
    public static ImageSlidingFragment newInstance() {
        ImageSlidingFragment fragment = new ImageSlidingFragment();
        return fragment;
    }
    ...
    private void initView(View view) {
        ...
        img_slide.setImageResource(R.drawable.card_manager1);
        textView.setText("VIB Values Debit Card");
    }
