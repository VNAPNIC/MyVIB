 ...
 */
public class MobiePhoneGetSecurityCodeFragment extends Fragment implements View.OnClickListener, NumberPad.IKeyCode, View.OnTouchListener, ViewDialog.IAction2ButtonV2 {
    ...
    public static MobiePhoneGetSecurityCodeFragment newInstance() {
        MobiePhoneGetSecurityCodeFragment fragment = new MobiePhoneGetSecurityCodeFragment();
        return fragment;
    }

    public static MobiePhoneGetSecurityCodeFragment newInstance(SecurityCode securityCode) {
        MobiePhoneGetSecurityCodeFragment fragment = new MobiePhoneGetSecurityCodeFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tho", "onCreate: mobie phone get security code");
    }
