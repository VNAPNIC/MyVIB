 ...
 */
public class MobiePhoneReceiptBillFragment extends Fragment implements View.OnClickListener {
    private View viewRoot;
    private MainActivity activity;
    private static final String MS = "key.ms";
    private SecurityCode securityCode;

    public static MobiePhoneReceiptBillFragment newInstance(SecurityCode securityCode) {
        MobiePhoneReceiptBillFragment fragment = new MobiePhoneReceiptBillFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tho", "onCreate: mobiphone bill fragment");
    }
