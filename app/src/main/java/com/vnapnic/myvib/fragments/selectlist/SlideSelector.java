package com.vnapnic.myvib.fragments.selectlist;
...
public class SlideSelector extends View {
    private static String TAG = SlideSelector.class.getCanonicalName();
    ...
    public SlideSelector(Context context, AttributeSet attrs, int defStyle) {
