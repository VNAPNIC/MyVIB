 ...
 */
public class OrdinarySavingsFragment extends Fragment {
    ...
    public static OrdinarySavingsFragment newInstance() {
        OrdinarySavingsFragment fragment = new OrdinarySavingsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        viewRoot = inflater.inflate(R.layout.fragment_ordinary_savings, container, false);
        return viewRoot;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new OrdinaryAdapter(activity, data());
        listView.setAdapter(adapter);
    }

    public List<OrdinarySavings> data() {
        Gson gson = new Gson();
        InterestRatesList response = gson.fromJson(getJson(activity, "Interest_rates.json"), InterestRatesList.class);
        return response.ordinarySavingses;
    }
