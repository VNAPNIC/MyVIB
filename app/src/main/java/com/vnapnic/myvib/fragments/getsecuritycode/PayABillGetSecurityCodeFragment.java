 ...
 */
public class PayABillGetSecurityCodeFragment extends Fragment implements View.OnClickListener, NumberPad.IKeyCode, View.OnTouchListener, ViewDialog.IAction2ButtonV2 {
    ...
    public static PayABillGetSecurityCodeFragment newInstance() {
        PayABillGetSecurityCodeFragment fragment = new PayABillGetSecurityCodeFragment();
        return fragment;
    }

    public static PayABillGetSecurityCodeFragment newInstance(SecurityCode securityCode) {
        PayABillGetSecurityCodeFragment fragment = new PayABillGetSecurityCodeFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tho", "onCreate: Pay a bill get security code");
    }
