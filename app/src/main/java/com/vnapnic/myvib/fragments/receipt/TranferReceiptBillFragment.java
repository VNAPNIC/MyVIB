 ...
 */
public class TranferReceiptBillFragment extends Fragment implements View.OnClickListener {
    private View viewRoot;
    private MainActivity activity;
    private static final String MS = "key.ms";
    private SecurityCode securityCode;

    public static TranferReceiptBillFragment newInstance(SecurityCode securityCode) {
        TranferReceiptBillFragment fragment = new TranferReceiptBillFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tho", "onCreate: tranferReceibill");
    }
