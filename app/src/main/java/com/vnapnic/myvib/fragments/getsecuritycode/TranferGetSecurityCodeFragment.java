 ...
 */
public class TranferGetSecurityCodeFragment extends Fragment implements View.OnClickListener, NumberPad.IKeyCode, View.OnTouchListener, ViewDialog.IAction2ButtonV2 {
    ...
    public static TranferGetSecurityCodeFragment newInstance() {
        TranferGetSecurityCodeFragment fragment = new TranferGetSecurityCodeFragment();
        return fragment;
    }

    public static TranferGetSecurityCodeFragment newInstance(SecurityCode securityCode) {
        TranferGetSecurityCodeFragment fragment = new TranferGetSecurityCodeFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tho", "onCreate: tranfer get security code");
    }
