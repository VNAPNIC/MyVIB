 ...
 */
public class BillFragment extends Fragment implements View.OnClickListener, PayAnyoneAdapter.IActionPayAnyoneAdapter {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_pay_a_bill:
                ((MainActivity) getActivity()).replaceFragment(BillAddressBook.newInstance());
                break;
            case R.id.pay_off_credit:
                ((MainActivity) getActivity()).replaceFragment(PayOffCreditFragment.newInstance());
                break;
        }
    }
